            ...
            .then(data => {
               let split = data.split(',')
                if (split[0].includes("True")){
                    window.location.href = 'https://www-student.cse.buffalo.edu/CSE442-542/2024-Spring/cse-442e/sprint3testing/s24semesterproject-brighterspace/brighterspace-react-app/build/TeacherHome'
                }
            })
